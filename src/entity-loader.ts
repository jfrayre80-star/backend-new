...
export const allEntities = [
  Users, Teachers, Admins, Parents, Students,
  Specialties, Semesters, Subjects, Groups, GroupEnrollments, Schedules, ExtraordinaryEnrollments,
  ClassroomTypes, Classrooms,
  QrCodes, AttendanceRecords, AccessLogs, Justifications, SyncQueue, OfflineOperations,
  EvaluationSchemes, PartialConfigs, PartialComponents, ComponentCriteria, Activities,
  ActivityDeliveries, ActivityExceptions, ActivityTeams, ActivityTeamMembers,
  Submissions, PartialGrades, ComponentScores, CriterionScores, DisciplinaryReports,
  Exams, ExamQuestions, QuestionContexts, ExamAttempts, ExamAnswers, FocusLossLogs,
  SemesterConfigs, SemesterGrades, AcademicHistory,
  CompanyTutors, DualEnrollments, DualMonthlySubjects, WeeklyLogs,
  Notices, Alerts, NotificationQueue,
  SystemConfig, ActiveSessions,
];
